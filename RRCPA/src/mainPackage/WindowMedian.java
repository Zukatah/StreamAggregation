...
public class WindowMedian extends Window
{
	...
	public WindowMedian (long windowEnd, AggregateOperation operation, String groupBy)
	{
	...
	{
		tupleList.addAll(((WindowMedian)pane).tupleList);					//First possible way to go; less work at all but more in the end
